...
def radix4_partial_products(a: Value, b: Value) -> list[Value]:
    ...
    extended_a = a.concat(Bits(1)(0)).zext(Bits(bits_a + 2))
        ...
        product = slice_a.case(
            {
                ...
                Bits(3)(0b001): b.concat(Bits(i)(0)).zext(Bits(bits)),
                Bits(3)(0b010): b.concat(Bits(i)(0)).zext(Bits(bits)),
                Bits(3)(0b011): b.concat(Bits(i + 1)(0)).zext(Bits(bits)),
                Bits(3)(0b100): neg_b.concat(Bits(i + 1)(0)).zext(Bits(bits)),
                Bits(3)(0b101): neg_b.concat(Bits(i)(0)).zext(Bits(bits)),
                Bits(3)(0b110): neg_b.concat(Bits(i)(0)).zext(Bits(bits)),
            }
        )
